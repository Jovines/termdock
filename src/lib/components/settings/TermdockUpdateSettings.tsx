...
export function TermdockUpdateSettings({ state, pending, onCheck, onConfirmRestart }: TermdockUpdateSettingsProps) {
  const { t } = useI18n();
      ...
      <div className="flex items-start justify-between gap-3 px-3 py-3">
        <div className="flex min-w-0 items-start gap-2.5">
          ...
          <div className="min-w-0">
            <div id="termdock-update-title" className="text-[12px] font-medium text-foreground">
